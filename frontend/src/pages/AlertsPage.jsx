    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {toast.message && (
                    <div style={{
                        fontSize: 11, color: dark ? '#6fa882' : '#3a6b4a', marginTop: 2,
    ...
    return (
      ...
      `}</style>
            ...
            <div style={{
                ...
                <div>
                    <h1 style={{
                        fontSize: isMobile ? 18 : 22, fontWeight: 900, color: C.text,
                    ...
                    return (
                        <div key={s.label} style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                <span style={{
                                    fontSize: 10, fontWeight: 630, color: dark ? C.textDim : '#5a7a66',
            ...
            >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 7, flexWrap: 'wrap', marginBottom: 3 }}>
                        ...
                        {alert.alert_type === 'ALARM' && alert.value_detected
                            ? (ALARM_CODES_FR[Math.round(alert.value_detected)] || `Alarme code ${Math.round(alert.value_detected)}`)
                            : cfg.label}
                        </span>
                        {alert._farm_name && (
